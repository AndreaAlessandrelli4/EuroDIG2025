...
if page == 'Overview':
    ...
    with c1:
        st.image("/home/a.alessandrelli/Euro2025/v4/App/Foto/COE-Logo-Quadri.png", use_container_width=True)
    with c5:
        st.image("/home/a.alessandrelli/Euro2025/v4/App/Foto/euroAVVOVChat.png", use_container_width=True)
    with c3:
        # Title & subtitle
    ...
    with team_cols1[4]:
        st.image("/home/a.alessandrelli/Euro2025/v4/App/Foto/logo.png", use_container_width=True)
    ...
    with team_cols[2]:
        st.image("/home/a.alessandrelli/Euro2025/v4/App/Foto/Pasquale.png", use_container_width=True)
        st.markdown(
            """
    ...
    with team_cols[4]:
        st.image("/home/a.alessandrelli/Euro2025/v4/App/Foto/Andrea.png", use_container_width=True)
        st.markdown(
            """
            <div style='text-align:center;'>
    ...
    with team_cols[6]:
        st.image("/home/a.alessandrelli/Euro2025/v4/App/Foto/Fabrizio.png", use_container_width=True)
        st.markdown(
            """
            <div style='text-align:center;'>
